...
export function CartProvider({ children }: CartProviderProps): JSX.Element {
  ...
  const removeProduct = (productId: number) => {
    try {
      ...
      const productsCartUpdated = cart.filter(product => product.id !== productId);

      setCart(productsCartUpdated);

      localStorage.setItem('@RocketShoes:cart', JSON.stringify(productsCartUpdated));
